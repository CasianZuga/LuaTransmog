...
local SlotNames = {
    [EQUIPMENT_SLOT_HEAD      ] = {"Casco",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_SHOULDERS ] = {"Hombros",    nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BODY      ] = {"Camiseta",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_CHEST     ] = {"Pechera",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WAIST     ] = {"Cintura",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_LEGS      ] = {"Piernas",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_FEET      ] = {"Botas",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WRISTS    ] = {"Brazales",       nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_HANDS     ] = {"Guantes",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BACK      ] = {"Espalda",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_MAINHAND  ] = {"Mano principal",    nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_OFFHAND   ] = {"Mano izquierda",     nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_RANGED    ] = {"Rango",       nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_TABARD    ] = {"Tabardo",       nil, nil, nil, nil, nil, nil, nil, nil},
}
local Locales = {
    {"Menu", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Eliminar todas las transmogrificaciones", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Eliminar transmogrificaciones de todo el equipo?", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Usar este objeto hará que se vuelva no-comerciable.\nDeseas continuar?", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Eliminar transmogrificacion de %s?", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Atras..", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Eliminar transmogrificacion", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Transmogrificaciones eliminadas de la armadura equipada", nil, nil, nil, nil, nil, nil, nil, nil},
    {"No tienes armas transmogrificables equipadas", nil, nil, nil, nil, nil, nil, nil, nil},
    {"%s transmogrificacion eliminada", nil, nil, nil, nil, nil, nil, nil, nil},
    {"No hay transmogrificacion en %s ", nil, nil, nil, nil, nil, nil, nil, nil},
    {"%s transmogrificado", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Selected items are not suitable", nil, nil, nil, nil, nil, nil, nil, nil},
    {"El arma seleccionado no existe", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Ranura de equipamiento vacia", nil, nil, nil, nil, nil, nil, nil, nil},
